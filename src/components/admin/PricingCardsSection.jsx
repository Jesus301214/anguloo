          ...
          <div className="space-y-8">
            ...
            >
              <div className="absolute top-0 right-0 p-6">
                <div className="bg-rose-500 text-white text-[10px] font-black px-4 py-2 rounded-full uppercase tracking-widest shadow-lg shadow-rose-500/20">
                  Recomendado
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-rose-600 text-sm font-bold uppercase tracking-widest">
                    Software + CRM + IA
                  </p>
                </div>
              </div>
