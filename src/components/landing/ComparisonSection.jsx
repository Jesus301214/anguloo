...
const painPoints = [
  {
    ...
    desc: 'No sabes quién dejó de ir ni por qué.',
  },
  {
    icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
    title: 'Pérdida de Tiempo',
    desc: 'Agendas manuales y reportes lentos.',
  },
  {
    icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
    title: 'Cero Claridad',
    desc: 'No conoces tu rentabilidad real.',
  },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 font-outfit mb-4">
            ¿Tu empresa se siente así?
          </h2>
          <p className="text-slate-600 text-lg">
            La falta de sistemas no solo quita tiempo, quita vida. Identifica tu estado actual.
          </p>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 text-lg">
            ¿Sigues operando en el pasado o estás listo para el futuro?
          </p>
        </div>
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={i} className="flex items-start gap-4 text-slate-500 font-bold group">
                  <span className="text-rose-500 mt-1 shrink-0 group-hover:scale-125 transition-transform text-xl">
                    ✕
                  </span>
            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-start gap-4 text-slate-700 font-black group">
                    <span className="text-emerald-500 mt-1 shrink-0 group-hover:scale-125 transition-transform text-xl">
                      ✓
                    </span>
                    <span className="group-hover:text-slate-900 transition-colors">{text}</span>
                  </li>
              ...
              <div className="mt-12">
                <button
                  ...
                  className="w-full bg-slate-900 text-white font-black py-4 rounded-2xl hover:bg-rose-500 transition-all shadow-xl shadow-slate-900/10"
                >
