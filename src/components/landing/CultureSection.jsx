...
const CultureSection = () => {
  ...
  useGSAP(
    () => {
      gsap.from('.culture-title', { y: 20, duration: 0.7, ease: 'power3.out', scrollTrigger: { trigger: sectionRef.current, start: 'top 85%' } })
      gsap.from('.culture-card', { y: 20, stagger: 0.1, duration: 0.6, ease: 'power3.out', scrollTrigger: { trigger: sectionRef.current, start: 'top 70%' } })
    },
    { scope: sectionRef },
  )
