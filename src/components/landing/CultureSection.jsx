      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-20">
          ...
          <p className="text-lg md:text-xl text-slate-600 font-medium leading-relaxed max-w-3xl mx-auto">
            Guiamos a empresas a descubrir sus pérdidas ocultas y construir una operación que
            funcione sola.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-16 items-start">
          <div className="lg:col-span-1">
            ...
            <p className="text-lg text-slate-600 leading-relaxed font-medium">
              No vendemos software genérico. Primero auditamos tu operación, detectamos los procesos
              que te cuestan tiempo y dinero, y luego diseñamos la automatización exacta que
              necesitas.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
            {cards.map((card, idx) => (
              <SpotlightCard
                key={idx}
                className="bg-white p-10 border-slate-100 shadow-md hover:shadow-xl"
              >
