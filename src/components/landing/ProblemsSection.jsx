        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-20">
          <div className="max-w-3xl">
            ...
            <h2 className="text-4xl md:text-6xl font-black text-slate-900 font-outfit mb-6 leading-[1.1]">
              ¿Qué hace que tu empresa tenga que{' '}
              <span className="text-rose-500">vivir en urgencias?</span>
            </h2>
            <p className="text-slate-600 text-xl">
              Evaluamos tu operación gratis. Estos son los dolores que encontramos en el 90% de los
              negocios que auditamos.
            </p>
          </div>
          <button
